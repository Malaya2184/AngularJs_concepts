(function(){
    ...
    .directive("listItemUrl",listItemUrl);

    function listItemUrl(){
        var listitemurl = {
            templateUrl: "listitem.html",
            scope: {
                // here ctrl is the name of the property comes from listitem.html which we want to be dynamic
                // then use my-ctrl as attribute in html to define the ctrl
                ctrl: '=myCtrl'
            }
        }
        return listitemurl;
